...
> [!NOTE]
>
> The power station will automatically attempt to connect to the last device it was paired to. If a connection cannot be established within five seconds, the unit will make itself available to other **Bluetooth®** enabled devices.

> [!NOTE]
>
> The **Bluetooth®** icon will flash in the display while the power station searches for compatible devices. Once a device is paired, the icon will turn solid.
...
> [!NOTE]
>
> When a new device is paired, the unit will automatically unpair from a connected device.
